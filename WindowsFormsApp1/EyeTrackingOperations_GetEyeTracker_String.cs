...
{
    internal static class EyeTrackingOperations_GetEyeTracker_String
    {
        internal static void Execute(string address)
        {
            EyeTrackingOperations_GetEyeTracker_String.GetEyeTracker(address);
        }
        // <BeginExample>
